...
public class PullToRefreshLayout extends RelativeLayout {
    ...
    @IntDef({SUCCEED, FAIL, CANCEL})
    public @interface RefreshResultTypes {
    }
     ...
     */
    /**
     * @param refreshResult PullToRefreshLayout.SUCCEED代表成功，PullToRefreshLayout.FAIL代表失败,NO_MORE没有更多
     */
    public void refreshFinish(@RefreshResultTypes final int refreshResult) {
        try {
    ...
    @Retention(RetentionPolicy.SOURCE)
    @IntDef({SUCCEED, FAIL, CANCEL, NO_MORE})
    public @interface LoadMoreResultTypes {
    }
     ...
     */
    public void loadmoreFinish(@LoadMoreResultTypes int refreshResult) {
        try {
            ...
            switch (refreshResult) {
                ...
                case CANCEL:
                    ...
                    if (null == customLoadmoreView) {
                        ...
                        if (loadStateTextView != null) {
                            loadStateTextView.setText("取消成功");
                        }
                        if (loadStateImageView != null) {
                            loadStateImageView
                                    .setBackgroundResource(R.drawable.load_succeed);
                ...
                case NO_MORE:
                    ...
                    if (null == customLoadmoreView) {
                        ...
                        if (loadStateTextView != null) {
                            loadStateTextView.setText(R.string.loading_no_more);
                        }
                        if (loadStateImageView != null) {
                            loadStateImageView
                                    .setBackgroundResource(R.drawable.load_failed);
        ...
        try {
            ...
            switch (state) {
                ...
                case LOADING:
                    ...
                    if (null == customLoadmoreView && pullUpView != null) {
